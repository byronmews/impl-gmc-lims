SELECT CANCER.genie_id, DEMOGRAPHICS.nhs_number, CANCER.lab_number, CANCER.blood_dna_to_ukb_fluidx_tube_barcode, CANCER.tissue_dna_to_ukb_fluidx_tube_barcode, CANCER.hospital, CANCER.disease_type, CANCER.status_impl_to_gosh_dispatch_date, CANCER.status_consent_date, CANCER.[status_blood], CANCER.[status_tissue], SWITCH
         (
