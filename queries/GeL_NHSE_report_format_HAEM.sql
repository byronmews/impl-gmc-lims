SELECT HAEM.genie_id, DEMOGRAPHICS.first_name, DEMOGRAPHICS.surname, HAEM.hospital, HAEM.status_germline, HAEM.status_cancer, HAEM.[status_stored_cell_in_stem_cell_lab/gtc], HAEM.disease_type, HAEM.status_impl_to_gosh_dispatch_date, SWITCH
        (
